...
include_once 'Consultas.php';
 ...
 $Pos = $_POST['RespuestaE'];
 	if($_POST['Seccion'] === "defaul" || $_POST['Preguntas'] === "defaul" || $_POST['RespuestaE'] === "defaul")
 		echo "Porfavor Seleccione una Opcion";
 	else{
 		if($Consulta->RegisEva($Usuario, $Nombre, $Sec, $Preg, $Observ, $Resp, $Pos))
 			echo "Registro de la Evaluacion Exitoso!!!";
 		else
 			echo "Ocurrio Algo Intentelo Mas Tarde";
 	}
 }else if(isset($_POST['Elim_Usu'])){
